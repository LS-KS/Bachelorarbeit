...
import cv2
cup6 = cv2.imread("cup6.png")

# Cut image to interesting size
width = cup6.shape[1]
height = cup6.shape[0]
slice_startx = width//3 + 15
slice_endx = 2*width//3-22
slice_starty = height//3+10
slice_endy = int(2.5*height//3-10)
cup6 = cup6[slice_starty: slice_endy, slice_startx : slice_endx]
...
plt.savefig("cup6_analyse.png", dpi=600, bbox_inches='tight')
plt.show()